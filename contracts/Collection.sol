...
contract Collection is ERC721URIStorage, Ownable {
    ...
    returns (uint256)
  {
    ...
    require(mintedAddress[msg.sender] < LIMIT_PER_ADDRESS, "Limit per address reached");
    require(_totalMinted.current() + 1 <= MAX_SUPPLY, "Max supply reached");
    require(URIMapping[tokenURI] == 0, "Token URI already exists");
